---
title: "Knowledge, Truth, Money and Powerless – Universities (a reponse)"
...
This is an open reply to a mate, Olger Quincy, a guest writer for the blog 
[“Devaluating Everything. Universities”](https://www.fresheconomicthinking.com/p/devaluating-everything-universities). 

I agree, Universities and education are indeed in need of reform, however ...  

I have to disagree with my beguiling friend Mr Quincy's view, that 
...
A sliding doors moment, for me, at age 18 while staking shelves at a 
supermarket, a customer offered me an apprenticeship as a builder. 
Little did I know back then, had I accepted this offer, I would today be in a much 
more financially secure position than my current career in academia and science,
which I love.
...
A striking example this, was a conversation I recall having in 2018 with a 
Southeast-Asian colleague about the [Murugappan 'Biloela' family](https://en.wikipedia.org/wiki/Murugappan_family_asylum_claims).
They conveyed their dismay that the family did not make use of this avenue for 
Australian citizenship and said they must have been poorly informed.
...
This article was proofread by LLM [gemma3:12b](https://ollama.com/library/gemma3:12b) 
model using [Ollama](https://ollama.com/) and [open-webui](https://openwebui.com/).
