...
```{r include=FALSE}
file.copy("../cercospoRa/docs/","./packages/cercospoRa",recursive = TRUE,overwrite = TRUE)
```
...
#### February/March 2024  
I presented at the GRDC updates in Goondiwindi and Dubbo.  
The Goondiwindi update was held at the Goondiwindi Community Centre and the Dubbo update was held at the Dubbo RSL.  
I presented on the decision support tools which have been developed on the GRDC funded project I am involved with.  
