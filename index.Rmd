...
### Nested lists in R  
#### November 2023  
This is a small bit of code I always forget and can never seem to google the answer 
to easily.
So I post it hear for myself to easily reference in the future.  

Wearing my programming hat and data-science hat, lists can be a extremely useful 
...
#head(nested_list)
```
Here we have created a list with a length of 10 with three lists nested inside each
