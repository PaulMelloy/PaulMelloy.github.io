...
Over the last ten years I have been religiously keeping track of my fuel usage 
for my Yammaha FZ6N motorcycle.
As a data nerd I have been interested in whether higher octane fuels are the 
better choice from a cost/distance view. 
Thanks to AI (claude) I have had help finding the time finishing off this shiny 
app.  

The shiny dashboard is accessible from the banner above or the link below and 
shows live data of every new entry automatically. 
It tracks fuel economy in L/100km and cost per kilometre across different octane 
grades (91 through 98), servo brands, and percent of highway riding. 
Interactive charts to help make your own mind up on whether premium fuel is 
actually worth the extra cents, which brands deliver the best efficiency, 
and how highway riding compares to city commuting.  

Enjoy!  

https://paulmelloy.shinyapps.io/Fuel_efficiency_FZ6N/  

<br>  

***  

### spatially explicit negative‑prognosis framework for Cercospora leaf spot using remote sensing
#### April 2026  

![](files/img/cercospora_logo.png){style="float: right" width=15%}  

Happy to finally see this collaborative piece of research finally published in the
European Journal of Plant Pathology. 
This shows how remote sensing can be used to augment mechanistic epidemiological
models.  

[A spatially explicit negative‑prognosis framework for Cercospora leaf spot using remotely sensed leaf area index](https://link.springer.com/article/10.1007/s10658-026-03194-6).
...
It was a pleasure to collaborate with UQ Computer science and Machine learning/ AI researchers Tianqi Wei, Zhi Chen, Xin Yu, Scott Chapman and Zi Huang. 
In this paper we explored how computer vision can segment disease lesions on images taken in the field.  

[A Large-Scale In-the-wild Dataset for Plant Disease Segmentation](https://www.nature.com/articles/s41597-025-06513-4)

You can also read a blog summary I wrote for the CSRIO agroecology team website.  

[New Research: Teaching Computers to Spot Plant Disease in the Real World ](https://research.csiro.au/agroecology/new-research-teaching-computers-to-spot-plant-disease-in-the-real-world/)
...
Lately I have been working on development of assessing canola growing regions
to estimate, at the landscape scale, 'pest control potential' ecosystem services.  

You can read more about it in a 
[blog post on the Canola Allies website](https://research.csiro.au/canolaallies/spatial-metrics-for-pest-control-potential/).
