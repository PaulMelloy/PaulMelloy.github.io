...
to take soil leaf samples for the UQ Industry kickstarter project.  

While it was late in the season and the vines entering domancy, we found, (Left) 
possible phosphorus deficiency in the ferrosol soils, and (Right) Possible downy mildew.

![possible phosphorus deficiency in the ferrosol soils](files/img/Possible_phos_deficient.jpg){width=30%}
![Possible downy mildew](files/img/possible_DownyMildew.jpg){width=30%}  

<br>  

Leaf samples revealed downy mildew _Plasmopara viticola_. 
(Left) Sporangiophore, (Right) Sporangia  


![Downy mildew conidia on the end of a conidiophore](files/img/Downy_conidiophore.jpg){width=30%}
![Downy mildew sporangia](files/img/Downy sporangia.jpg){width=35%}  
